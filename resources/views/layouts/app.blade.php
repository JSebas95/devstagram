...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @stack('styles') {{-- Para agregar hojas de estilos diferentes segun la vista --}}
    ...
    <body class="bg-gray-100">
      ...
      <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
        DevStagram - Todos los derehos reservados {{ now()->year }}
      </footer>
      {{--<nav>
        <a href="/">Principal</a>
      ...
      <h1 class="text-2xl font-black">@yield('titulo')</h1>
      <hr>
      @yield('contenido')--}}
    </body>
</html>